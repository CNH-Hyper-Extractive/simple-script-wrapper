    ...
    public class Utilities
    {
        ...
        public ElementSet AddElementsFromXmlFile(ElementSet omiElementSet, string xmlFilePath)
        {
            ...
            foreach (XmlNode node in elementSets)
            {
                ...
                // read the properties
                String id = elementSetNode.SelectSingleNode("ID").FirstChild.Value;
                String description = elementSetNode.SelectSingleNode("Description").FirstChild.Value;
                Int32 version = Convert.ToInt32(elementSetNode.SelectSingleNode("Version").FirstChild.Value);
                ElementType elementType = getXmlElementType(elementSetNode.SelectSingleNode("Kind").FirstChild.Value);
